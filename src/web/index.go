...
// The lock is the global lock that panics the process
// Provide it a logging interface and the directory of the client files
//
...
//
// Register all used middleware with Martini
//
