...
// Gets access to the global lock and logging
// It also asks for a port and the hosts for any backing you want to use
//
...
//
// Starts a goroutine that listens on all connections
// This goroutine routes connections, joins, heartbeats, etc
//
...
//
// Broadcasts a message to all listening clients
//
...
//
// Broadcast a message to all clients announcing a user joining the room
//
...
//
// Broadcast a message to all clients announcing a user leaving the room
//
...
//
// Negotitate a client entering the room
//
...
//
// Return a list of clients listening on the server
//
...
// Links a username to a connection client
//
...
//
// Decide what data backing to use
//
