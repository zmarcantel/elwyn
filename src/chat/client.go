...
//
// Spins up a goroutine to listen for events
// Main entry for hangups and reading messages sent to server
//
...
// Locks until a message is received.
//
...
//
// Initialize the PingPong loop
// The server beings sending a ping which the client responds to
// This is repeated to keep the client connection open
//
...
//
// Synchronize the client with the server state
// This forces and/or allows synchronization of users, messages, etc
//
...
//
// Determine if the client should be synced
// Sync frequency is tuned based on heartbeat frequency and sync interval
//
...
//
// Create a new client to the server
//
